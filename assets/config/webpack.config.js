...
// makes for a smoother statics process.
...
module.exports = function(webpackEnv) {
  ...
  // passed into alias object. Uses a flag if passed into the statics command
  ...
  return {
    ...
    optimization: {
      ...
      minimizer: [
        ...
        new TerserPlugin({
          ...
          // Use multi-process parallel running to improve the statics speed
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            // In production, they would get copied to the `statics` folder.
    ...
    plugins: [
      ...
      // the HTML & assets that are part of the Webpack statics.
      isEnvProduction &&
